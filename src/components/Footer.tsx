  ...
  return (
    <footer className='bg-white'>
      {pathsToMinimize.some(path => pathname.includes(path)) ? null : (
        <div className='relative bg-zinc-50 flex flex-col items-center sm:py-4 lg:mt-0'>
          <div className='p-4 flex justify-center'>
            <Icons.logo className='h-12 w-auto' />
          </div>
          <div className='absolute inset-0 overflow-hidden rounded-lg'>
            <div aria-hidden='true' className='absoluteinset-0 bg-gradient-to-br bg-opacity-90' />
          </div>
